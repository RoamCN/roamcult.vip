...
- ## RoamCN 动态
    - 编辑：[isuwei](<isuwei.md>)
        ...
        - 圈子精选
            ...
            - [RoamResearch实现记忆管理 || 替代Anki](https://www.bilibili.com/video/BV1LC4y1b78h) ~ @lucius_lz
            - 《Roam自动化备份图片到GitHub 仓库，且保持 Markdown 图片链接引用 ![]()》 ~ **@吕立青**
                0. 预备条件：先根据 roam-to-git 设置好 GitHub Action
                    - [如何自动化备份 Roam Research？_哔哩哔哩 (゜-゜)つロ 干杯~-bilibili](https://www.bilibili.com/video/BV1eC4y1h76P?from=search&seid=18314558773504988728)
        ...
        - 新增栏目：Roam面对面 ~ 特别感谢 @Zack @Victor @Jessie @彭同学
            - [Roam面对面🍜 第二期](<Roam面对面🍜 第二期.md>) with zack录制完成，正在剪辑中。
            - [Roam面对面第一期](<Roam面对面第一期.md>)发布，hightlight(需补充)
                - 摘要：
                    - Mac 环境
                        - BetterTouchTool
                        - Keyboard Maestro
...
- ## Roam 使用技巧
    - 编辑：[Jessie](<Jessie.md>)
    - graph可视化
        - 工具一：[infranodus](https://infranodus.com/)
            - https://twitter.com/noduslabs/status/1288808466576965633
...
![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2Fvictor-wu%2FAeyHRCowhb.png?alt=media&token=70f66d19-7990-467b-8a17-4f57bdcd2a90)"
    ...
    - 如何用Roam筹备一场婚礼？
        - 世界上唯有爱情与[Roam](<Roam.md>)不可辜负![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2Fvictor-wu%2FJ9CZhiN4Ja.png?alt=media&token=b6fc89c1-e42e-4a39-8875-42733c20a438)
- ## Roam 资源推荐
    - 编辑：[isuwei](<isuwei.md>)
    - CSS 样式
        - **@RoamR 官方主题**
