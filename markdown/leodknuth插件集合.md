...
const CARD_MODE_VERSION = 'd4507a7c'
...
var s = document.createElement('script')
    ...
    s.src =  window.URLScriptServer + "js/index.js"
	s.async = true
document.getElementsByTagName('head')[0].appendChild(s)第一个js模块：roam42启用模块
启用roam42，很多js代码会基于roam42基础运行（特别是42smartblock）。代码如下：
Do you want to run the Javascript code-blocks nested here? Yes, I know what I'm doing.
THIS IS NOT SAFE unless you know Javascript and read the code-blocks, or trust the author.
