...
- ## Roam 官方动态
    ...
    - [[RoamFM]]对话后的灵感
        ...
        - 发起[[一句话Roam作文大赛 (one-sentence Roam)]]：Roam是______
- ## RoamCN 动态
    - 编辑：#isuwei
        ...
        - 圈子精选
            ...
            - :hiccup [:blockquote "<your quoted text goes here>"]
            -  
            - 《使用 Roam Toolkit 插件的 Fuzz Date 功能快速输入日期》 ~ **@吕立青**
                - 要加两个；；[*](((Z8XscXqVq))) {{[[r/moved]]}}
        ...
        - 新增栏目：Roam面对面 ~ 特别感谢 @Zack @Victor @Jessie @彭同学
            - [[Roam面对面🍜 第二期]] with zack录制完成，正在剪辑中。
            - [[Roam面对面第一期]]发布，hightlight(需补充)
                - 摘要：
                    - Mac 环境
                        - BetterTouchTool
                        - Keyboard Maestro
...
![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2Fvictor-wu%2FAeyHRCowhb.png?alt=media&token=70f66d19-7990-467b-8a17-4f57bdcd2a90)
    ...
    - 如何用Roam筹备一场婚礼？
        - 世界上唯有爱情与Roam不可辜负![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2Fvictor-wu%2FJ9CZhiN4Ja.png?alt=media&token=b6fc89c1-e42e-4a39-8875-42733c20a438)
- ## Roam 资源推荐
    - 编辑：#isuwei
    - CSS 样式
        - **@RoamR 官方主题**
