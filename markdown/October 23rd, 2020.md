- [[kunpeng9]].serious[因为有时候也用kunpeng9，所以两个都加上双链]  [[kunpeng9.serious]] =今天尝试把roamcn的全部内容导出为md，再导入ob，看看效果；发现提取的时容易出问题【命名等有问题=出了问题文件名、目录名或卷标语法不正确。（Excep_FromHResult 0x8007007B）】，一些内容不得不点击跳过；
